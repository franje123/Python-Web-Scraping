...
import requests
import re
########## MUST IMPORT sys MODULE SO sys.exit(1), in In[2] will work #############
import sys    
...
def save_file(text):
    ...
    # Use the 'with' statement to open the file and write the text
...
if __name__ == '__main__':
        ...
        # Give url as if __name__ == '__main__':
